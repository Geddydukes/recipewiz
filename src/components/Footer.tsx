      ...
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="inline-block text-2xl font-heading font-semibold mb-4">
              <span className="text-primary">Smart</span>Recipe
            </a>
            <p className="text-gray-600 mb-6 max-w-md">
              The ultimate cooking companion that makes meal planning, recipe management, and grocery 
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Smart Recipe. All rights reserved.
            </p>
            <p className="text-gray-500 text-sm flex items-center mt-4 md:mt-0">
              Made with <Heart className="w-4 h-4 mx-1 text-red-500" /> by SmartRecipe Team
            </p>
          </div>
        </div>
      </div>
